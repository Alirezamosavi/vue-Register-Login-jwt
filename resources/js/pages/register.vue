      ...
      <div class="col-6">
  	 ...
  	 <div class="alert alert-danger" v-if="has_error && !success">
		...
		>
			...
			> -->
			 <div class="form-group" v-bind:class="{ mx_recaptcha_failed: !recaptcha }">  <!-- this class is for error and show to User  -->
				<vue-recaptcha
					sitekey="6LdIte4ZAAAAAHe7VSF6MNOghHyOFJ8soSy0FSiC"
					@verify="mxVerify"
				></vue-recaptcha>
				
				<small>Doesn't complete!</small>  <!-- this class is for error and show to User  -->
			</div>
   ...
   data() {
	...
	methods: {
		mxVerify( response ) {
			...
			this.recaptcha = response   // I PUT IT IN THIS PLACE AND SHOW RECAPTCHA TO RESPONSE
		...
		register() {
          ...
          error: function (res) {
            ...
            app.errors = res.response.data.errors || {}
					...
					this.formInv = true  // IF THERE ARE ERROR SHOW THAT IN FORM OF HTML
					}
			}else {
